//
//  Offersviewsheet.swift
//  Baccvs iOS
//
//  Created by pm on 01/09/2023.
//

import SwiftUI
import RevenueCat
struct Offersviewsheet : View {
    ...
    var body: some View {
        ZStack{
            ...
            Text("Enjoy more by getting access to all the feature s of the BACCVS APP")
                        ...
                        NavigationLink( destination: TabNavPage() , isActive: $uVM.gotohome){
...
struct Offersviewsheet_Previews: PreviewProvider {
